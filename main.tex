...
\begin{document}
	...
	Comprehending the author's message and its immediate impact is only the first half of the equation; the remaining, equally crucial half is meticulous documentation and easy access --- and there is no better archival program for this than Zotero. It's cross-platform, free, open-source, and offers generous storage on its free tier.
